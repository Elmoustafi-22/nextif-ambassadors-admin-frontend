    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-[#F8FAFC]">
        <motion.div
          ...
          className="bg-white rounded-4xl shadow-xl shadow-blue-500/5 p-8 border border-neutral-100 text-center max-w-md w-full"
        >
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#F8FAFC]">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="mb-8 text-center">
            <img
              ...
              alt="Logo"
              className="w-14 h-14 mb-6 mx-auto shadow-lg object-center shadow-blue-600/20 rounded-2xl cursor-pointer"
          ...
          <div className="flex items-center gap-2 mb-6">
            <div className={`flex-1 h-1 rounded-full transition-colors duration-300 ${step >= 1 ? "bg-blue-600" : "bg-neutral-200"}`} />
            <div className={`flex-1 h-1 rounded-full transition-colors duration-300 ${step >= 2 ? "bg-blue-600" : "bg-neutral-200"}`} />
          </div>
          ...
          <button
            type="button"
            onClick={() => navigate("/login")}
            className="w-full text-center text-sm font-heading font-bold text-neutral-500 hover:text-blue-600 transition-colors py-4 mt-2"
          >
            Back to Login
          </button>
        </motion.div>
        ...
        <p className="text-center text-neutral-400 text-xs mt-8">
          &copy; 2025 NextIF Administrator Portal. All rights reserved.
        </p>
      </div>
    </div>
  );
